...
import com.example.admin.drinkshopserver.Adapter.DrinkListAdapter;
    ...
    private void showAddDrinkDialog() {
        ...
        builder.setNegativeButton("CANCEL", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                {
                    Toast.makeText(DrinkListActivity.this, "Please enter image of product", Toast.LENGTH_SHORT).show();
                    return;
                }
